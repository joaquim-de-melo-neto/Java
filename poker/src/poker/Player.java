...
//	checa por 05 cartas do mesmo naipe
	public boolean checkFlush() {
		for(int index=0; index<hand.length-1;index++) {
			if(!hand[index].getSuit().equals(hand[index+1].getSuit())) return false;
		}
		return true;
	}
...
//	checa por um full house. uma trinca e um par ao mesmo tempo
	public boolean checkFullHouse() {
		if (hand[0].getFace().equals(hand[1].getFace()) && hand[2].getFace().equals(hand[3].getFace()) && hand[3].getFace().equals(hand[4].getFace())
		   || hand[0].getFace().equals(hand[1].getFace()) && hand[1].getFace().equals(hand[2].getFace()) && hand[3].getFace().equals(hand[4].getFace()))
			return true;
		return false;
	}
